...
// Also, I am not sure that you need this enum. It can create a lot of problems in future if you will try to modify it in the future,
// because it is some sort of integer and if you will add something between existing categories it will corrupt some logic. You will need to
